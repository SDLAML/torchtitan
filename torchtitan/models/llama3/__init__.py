...
# from torchtitan.components.tokenizer import build_hf_byte_tokenizer
...
# from .model.args import RoPEScalingArgs
...
llama3_args = {
    ...
    "data_tiny": TransformerModelArgs(
        dim=1024,
        n_layers=36,
        n_heads=16,
        n_kv_heads=4,
    ...
    "data_small": TransformerModelArgs(
        dim=2048,
        n_layers=24,
        n_heads=16,
        n_kv_heads=4,
