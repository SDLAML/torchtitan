...
moe_opt_moe_configs = {
    ...
    #
    # =========== trustllm model
    "trustllm-8b": OPTMoEModel.Config(
        n_layers=24,
        dim=2048,
        swa_pattern="FSSSSF" + "SSSSSF" * 3,
        rope_pattern="NRRRRN" + "RRRRRN" * 3,
        layer=OPTMoETransformerBlock.Config(
            n_dense_layers=1,
            feed_forward=FeedForward.Config(
                hidden_dim=5120,
    ...
    "trustllm-8b-wo-gate": OPTMoEModel.Config(
        n_layers=24,
        dim=2048,
        swa_pattern="FSSSSF" + "SSSSSF" * 3,
        rope_pattern="NRRRRN" + "RRRRRN" * 3,
    ...
    "trustllm-8b-proxy": OPTMoEModel.Config(
        n_layers=24,
        dim=512,
        swa_pattern="FSSSSF" + "SSSSSF" * 3,
        rope_pattern="NRRRRN" + "RRRRRN" * 3,
